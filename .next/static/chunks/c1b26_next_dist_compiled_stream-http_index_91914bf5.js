...
"[project]/node_modules/.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/stream-http/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
(function() {
    var e = {
        ...
        813: function(e, t, r) {
            ...
            f.request = function(e, t) {
                ...
                var r = ("TURBOPACK ident replacement", globalThis).location.protocol.search(/^https?:$/) === -1 ? "http:" : "";
                var i = e.protocol || r;
        ...
        301: function(e, t) {
            t.fetch = isFunction(("TURBOPACK ident replacement", globalThis).fetch) && isFunction(("TURBOPACK ident replacement", globalThis).ReadableStream);
            t.writableStream = isFunction(("TURBOPACK ident replacement", globalThis).WritableStream);
            t.abortController = isFunction(("TURBOPACK ident replacement", globalThis).AbortController);
            var r;
            function getXHR() {
                if (r !== undefined) return r;
                if (("TURBOPACK ident replacement", globalThis).XMLHttpRequest) {
                    r = new ("TURBOPACK ident replacement", globalThis).XMLHttpRequest;
                    try {
                        r.open("GET", ("TURBOPACK ident replacement", globalThis).XDomainRequest ? "/" : "https://example.com");
                    } catch (e) {
                        r = null;
                    }
                } else {
                ...
                if (e._mode === "fetch") {
                    ...
                    if (n.abortController) {
                        ...
                        if ("requestTimeout" in t && t.requestTimeout !== 0) {
                            e._fetchTimer = ("TURBOPACK ident replacement", globalThis).setTimeout(function() {
                                e.emit("requestTimeout");
                                if (e._fetchAbortController) e._fetchAbortController.abort();
                            }, t.requestTimeout);
                        }
                    }
                    ("TURBOPACK ident replacement", globalThis).fetch(e._opts.url, {
                        ...
                        ("TURBOPACK ident replacement", globalThis).clearTimeout(e._fetchTimer);
                        if (!e._destroyed) e.emit("error", t);
                    });
                } else {
                    var l = e._xhr = new ("TURBOPACK ident replacement", globalThis).XMLHttpRequest;
                    try {
                ...
                if (r === "fetch") {
                    ...
                    if (n.writableStream) {
                        var s = new WritableStream({
                            ...
                            close: function() {
                                ("TURBOPACK ident replacement", globalThis).clearTimeout(i);
            ...
            s.prototype._onXHRProgress = function() {
                ...
                switch(e._mode){
                    ...
                    case "ms-stream":
                        ...
                        var s = new ("TURBOPACK ident replacement", globalThis).MSStreamReader;
        ...
        781: function(e) {
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/stream-browserify/index.js [app-client] (ecmascript)");
        },
        310: function(e) {
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/native-url/index.js [app-client] (ecmascript)");
        },
        837: function(e) {
            "use strict";
    ...
    if (typeof __nccwpck_require__ !== "undefined") __nccwpck_require__.ab = ("TURBOPACK compile-time value", "/ROOT/node_modules/.pnpm/next@15.4.4_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/stream-http") + "/";
...
//# sourceMappingURL=c1b26_next_dist_compiled_stream-http_index_91914bf5.js.map